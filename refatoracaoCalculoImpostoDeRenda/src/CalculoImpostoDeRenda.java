public class CalculoImpostoDeRenda {
    ...
    public static void main(String[] args) {
        ...
        CalculoImpostoDeRenda[] PessoaFisica=new CalculoImpostoDeRenda[3];
        CalculoImpostoDeRenda[] PessoaJuridica=new CalculoImpostoDeRenda[3];
        
        for (CalculoImpostoDeRenda c : PessoaFisica){
